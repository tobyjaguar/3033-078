...
contract VickreyAuction is Auction {
    ...
    function commitBid(bytes32 bidCommitment)
      public
      payable
    {
        ...
        if(commitments[msg.sender] == bytes32(0))
          ...
          require(msg.value == 0, "you already deposited");
      ...
      returns(bool isHighestBidder)
    {
        ...
        require(commitments[msg.sender] == keccak256(abi.encodePacked(msg.value, nonce)));
        if(highestBid < msg.value) // highest bidder
        {
          ...
          if(highestBid == 0)
            ...
            secondHighestBid = refund - bidDepositAmount;
