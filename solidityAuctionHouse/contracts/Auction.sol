...
contract Auction {
        ...
        public
    {
        ...
        {
          require(msg.sender == judgeAddress || msg.sender == winnerAddress, "Only the judge or winner can call this");
        }
        uint256 balanceBefore = balances[sellerAddress];
        balances[sellerAddress] += winningPrice;
        require(balances[sellerAddress] >= balanceBefore, "Finalize failed, math error");
    }
        ...
        public
    {
        ...
        //require(auctionExpiry<time(), "Auction must be expired");
        if(judgeAddress == address(0))
            require(msg.sender == sellerAddress, "Only the seller or judge can refund");
        else
            require(msg.sender == judgeAddress || msg.sender == sellerAddress, "Only the seller or judge can refund");
        ...
        require(balances[winnerAddress] >= balanceBefore, "Refund failed, math error");
    }
        ...
        public
    {
        ...
        address(msg.sender).transfer(sendAmt);
    }
